      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li class="c"><nuxt-link to="/article/prediction/1">今日预测</nuxt-link></li>
            <li class="c"><router-link to="/article/stock/6">股市人生</router-link></li>
            <li class="c"><router-link to="/article/report/10">月度报告</router-link></li>
            <li class="c"><router-link to="/article/research/14">实地调研</router-link></li>
            <li class="c"><router-link to="/article/investment/18">投资哲学</router-link></li> 
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="c"><router-link to="/video">精彩视频</router-link></li>
